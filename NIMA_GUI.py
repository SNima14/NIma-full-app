from typing import Tuple                            # MADE
from typing import Any, Tuple                       # BY
from tkinter.messagebox import showerror, showinfo  # NIMA
from customtkinter import *                         # HOMAM
...
class Midbar(CTkFrame):
    def __init__(
        ...
        **kwargs,
        ...
        def usless_btn_comand():
            showinfo(title="useless", message="It is really useless I am sorry")
        ...
        self.useless_btn = CTkButton(
            self.top_right, text="useless button", width=160, command=usless_btn_comand
        )
        self.useless_btn.pack(pady=(15, 0), padx=5)
